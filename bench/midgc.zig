...
pub fn main() !void {
    ...
    std.debug.print(
        "{s:>6} {s:>9} {s:>9} {s:>9} {s:>9} {s:>9} {s:>11} {s:>9} {s:>9} {s:>9} {s:>9} {s:>11} {s:>11} {s:>12}\n",
        .{ "runs", "attempts", "sweeps", "aborts", "pub-abort", "rnd-abort", "generations", "wait-poll", "fin-retry", "run-peer", "park-peer", "published", "pause-us", "pause-max-us" },
    );
    std.debug.print(
        "{d:>6} {d:>9} {d:>9} {d:>9} {d:>9} {d:>9} {d:>11} {d:>9} {d:>9} {d:>9} {d:>9} {d:>11} {d:>11} {d:>12}  wall={d} us\n",
        .{
            runs + 1,
