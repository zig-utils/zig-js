...
pub fn build(b: *std.Build) void {
    ...
    const fuzz_lifecycle = b.option(bool, "fuzz-lifecycle", "threadfuzz: deterministic termination, Worker/module-worker graph overlap, Thread.restrict/ThreadLocal isolation, finalization cleanup/waiter/unregister, and close/terminate lifecycle profile") orelse false;
