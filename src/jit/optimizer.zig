...
fn depthEffect(inst: bc.Inst) DepthEffect {
    return switch (inst.op) {
        ...
        .load_binding_ref => .{
            .required = 0,
            .removed = 0,
            .added = if ((inst.b & bc.binding_ref_load_with_base) != 0) 2 else 1,
        },
        ...
        .call_with_this, .call_eval_with_this, .tail_call_with_this, .tail_call_eval_with_this => .{ .required = inst.a +| 2, .removed = inst.a +| 2, .added = 1 },
        .call_spread, .call_eval_spread, .tail_call_spread, .new_spread => .{ .required = 2, .removed = 2, .added = 1 },
        .call_with_this_spread, .call_eval_with_this_spread, .tail_call_with_this_spread => .{ .required = 3, .removed = 3, .added = 1 },
        ...
        .object_rest => .{ .required = inst.a +| 1, .removed = inst.a +| 1, .added = 1 },
