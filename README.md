...
The current exported C surface has 80 functions:
...
- **Values** - type and Symbol/BigInt predicates, equality, primitive and fresh-Symbol construction, coercions, and protected handles.
