...
`zig build` installs `libzig-js.a` and compatible headers under `zig-out/`. See the [Zig API](src/root.zig), [C API](docs/api.md), [architecture](docs/architecture.md), [WebAssembly](docs/wasm.md), and [threads/GC](docs/threads/index.md).
