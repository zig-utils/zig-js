...
> `zig build test262` currently passes **VALID 26,114 / 30,486 (85.7%)** across `language/`
...
| ---- | ------- | ------: |
| **valid** | can we run the program? | **26,114 / 30,486 (85.7%)** |
...
| `String` | 1,025 / 1,223 (83.8%) | | `Promise` | 561 / 677 (82.9%) |
