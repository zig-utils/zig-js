...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,319 / 3,341 (69.4%) |
...
Latest focused `test/intl402` worker checkpoint: **2,319 / 3,341 (69.4%)**, up **+129** from the previous focused checkpoint of 2,190 / 3,341 after the Temporal calendar-aware difference and locale-formatting fixes.
