...
- automatic/concurrent compaction, a moving nursery, and optimizing-tier execution beyond the guarded numeric SSA and exact two-way branch subset; see the [optimizer status](docs/optimizing-jit.md).
