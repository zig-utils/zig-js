...
> The latest full run passes **VALID 34,219 / 41,664 (82.1%)**, with **135 parse failures**,
> **7,310 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **34,219 / 41,664 (82.1%)** |
...
| `Proxy` | 289 / 310 (93.2%) | `Reflect` | 153 / 153 (100%) |
