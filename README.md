...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,588 / 3,341 (77.5%) |
...
Latest focused `test/intl402` worker checkpoint: **2,588 / 3,341 (77.5%)**, up **+3** from the previous focused checkpoint of 2,585 / 3,341 after the Temporal non-era calendar field validation fixes.
