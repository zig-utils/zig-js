...
> The latest full run passes **VALID 40,705 / 47,928 (84.9%)**, with **146 parse failures**,
> **7,077 runtime failures**, **0 host failures**, and **NEGATIVE 3,213 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **40,705 / 47,928 (84.9%)** |
...
| `Map` | 204 / 204 (100%) | `Set` | 375 / 383 (97.9%) |
