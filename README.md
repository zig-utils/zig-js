...
> The latest full run passes **VALID 33,835 / 41,664 (81.2%)**, with **135 parse failures**,
> **7,694 runtime failures**, **0 host failures**, and **NEGATIVE 3,180 / 4,668 (68.1%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,835 / 41,664 (81.2%)** |
...
| `Number` | 337 / 340 (99.1%) | `WeakSet` | 85 / 85 (100%) |
