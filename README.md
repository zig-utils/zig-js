...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,600 / 3,341 (77.8%) |
...
Latest focused `test/intl402` worker checkpoint: **2,600 / 3,341 (77.8%)**, up **+2** from the previous focused checkpoint of 2,598 / 3,341 after routing Temporal PlainMonthDay `toJSON` through the ISO Temporal string formatter instead of locale formatting.
