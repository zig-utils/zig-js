...
- remaining native optimizer object/array effects, eval/spread/tail-call forms, dynamic-finally dispatch, and additional architecture backends. AArch64 executes profiled dynamic arithmetic/comparisons plus unary, bitwise, property, membership, and invocation effects through precisely rooted callbacks; see [optimizer status](docs/optimizing-jit.md).
