...
> The latest full run passes **VALID 33,916 / 41,664 (81.4%)**, with **135 parse failures**,
> **7,613 runtime failures**, **0 host failures**, and **NEGATIVE 3,180 / 4,668 (68.1%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,916 / 41,664 (81.4%)** |
...
| ---- | ------: | ---- | ------: |
| `language` | 12,703 / 14,285 (88.9%) | `Object` | 3,218 / 3,411 (94.3%) |
| `Array` | 2,599 / 2,991 (86.9%) | `RegExp` | 1,460 / 1,687 (86.5%) |
| `String` | 1,069 / 1,223 (87.4%) | `TypedArray` | 1,216 / 1,446 (84.1%) |
...
| `decodeURIComponent` | 56 / 56 (100%) | `encodeURI` | 31 / 31 (100%) |
| `encodeURIComponent` | 31 / 31 (100%) | `AsyncIteratorPrototype` | 9 / 9 (100%) |
