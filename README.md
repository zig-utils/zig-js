...
- remaining native optimizer object/array effects, dynamic arithmetic, eval/spread/tail-call forms, dynamic-finally dispatch, and additional architecture backends. AArch64 executes unary, exponentiation, bitwise, and shift coercions plus property access, membership, calls, and construction through precisely rooted callbacks with exact exception continuations; see [optimizer status](docs/optimizing-jit.md).
