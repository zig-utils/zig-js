...
> The latest full run passes **VALID 40,971 / 47,928 (85.5%)**, with **146 parse failures**,
> **6,811 runtime failures**, **0 host failures**, and **NEGATIVE 3,213 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **40,971 / 47,928 (85.5%)** |
