...
> The latest full run passes **VALID 33,828 / 41,664 (81.2%)**, with **135 parse failures**,
> **7,701 runtime failures**, **0 host failures**, and **NEGATIVE 3,180 / 4,668 (68.1%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,828 / 41,664 (81.2%)** |
...
| `Number` | 332 / 340 (97.6%) | `WeakSet` | 85 / 85 (100%) |
...
| `ThrowTypeError` | 14 / 14 (100%) | `NaN` | 6 / 6 (100%) |
