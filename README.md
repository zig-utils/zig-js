...
files**, classified as 431 private (**247 implemented / 184 pending**), 15
...
The first 247 private exports—encoded identity/cell equality, truthiness,
...
errors, and namespace waiters are precise-GC roots. The 246-symbol combined
fixture covers sibling realms,
...
separately compiled fixtures pass 20 real cell kinds for each. All 247
...
437 symbols from 54 `src/jsc` files: 421 private (**241 implemented / 180
