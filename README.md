...
- additional native optimizer architecture backends. AArch64 executes profiled dynamic arithmetic/comparisons plus unary, bitwise, guarded named-property and packed existing-index reads/writes (including loops), membership, direct-eval, spread, invocation, construction, literal initialization, proper-tail-call effects, and exact completion dispatch; see [optimizer status](docs/optimizing-jit.md).
