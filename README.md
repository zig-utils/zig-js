...
> The latest full run passes **VALID 34,245 / 41,664 (82.2%)**, with **135 parse failures**,
> **7,284 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **34,245 / 41,664 (82.2%)** |
...
| `Proxy` | 309 / 310 (99.7%) | `Reflect` | 153 / 153 (100%) |
