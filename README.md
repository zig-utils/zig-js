...
> The latest full run passes **VALID 33,739 / 41,664 (81.0%)**, with **135 parse failures**,
> **7,790 runtime failures**, **0 host failures**, and **NEGATIVE 3,180 / 4,668 (68.1%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,739 / 41,664 (81.0%)** |
...
| ---- | ------: | ---- | ------: |
| `language` | 12,687 / 14,285 (88.8%) | `Object` | 3,203 / 3,411 (93.9%) |
