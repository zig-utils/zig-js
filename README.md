...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,397 / 3,341 (71.7%) |
...
Latest focused `test/intl402` worker checkpoint: **2,397 / 3,341 (71.7%)**, up **+22** from the previous focused checkpoint of 2,375 / 3,341 after the Temporal ZonedDateTime locale-formatting fixes.
