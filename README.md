...
- native optimizer object effects, call-exception and dynamic-finally dispatch regions, and additional architecture backends. Current AArch64 numeric regions include reducible nested loops, deterministic catch/finally bodies, and exact call/effect unwind metadata; see [optimizer status](docs/optimizing-jit.md).
