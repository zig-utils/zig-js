...
- optimizer CFGs beyond one shared/independent-latch inner branch or a reducible chain of exact conditional exits; native object effects; and additional backends. Current numeric SSA has exact bytecode exits and live moving-GC loop safepoints; see [optimizer status](docs/optimizing-jit.md).
