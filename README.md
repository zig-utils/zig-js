...
- most native optimizer object effects, calls, dynamic-finally dispatch, and additional architecture backends. AArch64 executes `to_numeric` through a precisely rooted callback and resumes exact catch/finally continuations without replay; see [optimizer status](docs/optimizing-jit.md).
