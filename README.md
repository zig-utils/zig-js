...
> The latest full run passes **VALID 34,136 / 41,664 (81.9%)**, with **135 parse failures**,
> **7,393 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **34,136 / 41,664 (81.9%)** |
...
| ---- | ------: | ---- | ------: |
| `language` | 12,745 / 14,285 (89.2%) | `Object` | 3,225 / 3,411 (94.5%) |
...
| `annexB` | 461 / 1,070 (43.1%) | `staging` | 625 / 991 (63.1%) |
...
| `Proxy` | 267 / 310 (86.1%) | `Reflect` | 147 / 153 (96.1%) |
