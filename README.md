...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,593 / 3,341 (77.6%) |
...
Latest focused `test/intl402` worker checkpoint: **2,593 / 3,341 (77.6%)**, up **+2** from the previous focused checkpoint of 2,591 / 3,341 after validating Temporal PlainMonthDay non-ISO calendar object fields with calendar-aware month codes and reference years.
