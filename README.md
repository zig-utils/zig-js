...
files**, classified as 432 private (**31 implemented / 401 pending**), 15
...
The first thirty-one private exports—encoded identity/cell equality, truthiness,
...
two object-coercion/prototype operations—now pass focused Zig
...
separately compiled fixtures pass 20 real cell kinds for each. All thirty-one
...
437 symbols from 54 `src/jsc` files: 422 private (**31 implemented / 391
