...
files**, classified as 432 private (**33 implemented / 399 pending**), 15
...
The first thirty-three private exports—encoded identity/cell equality, truthiness,
...
two object-coercion/prototype operations, and two numeric DateInstance
operations—now pass focused Zig
...
separately compiled fixtures pass 20 real cell kinds for each. All thirty-three
...
437 symbols from 54 `src/jsc` files: 422 private (**33 implemented / 389
