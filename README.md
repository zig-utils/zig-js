...
- additional native optimizer architecture backends. AArch64 executes profiled dynamic arithmetic/comparisons plus unary, bitwise, inline guarded property reads, guarded property writes, membership, direct-eval, spread, invocation, construction, literal object/array initialization, proper-tail-call effects, and exact normal/throw/return/break/continue dispatch; see [optimizer status](docs/optimizing-jit.md).
