...
| Wasm GC terminal corpus | **697 / 697 applicable** | [inventory](docs/.data/wasm-gc-runtime-inventory.json) · [#300](https://github.com/zig-utils/zig-js/issues/300) |
...
- remaining Memory64/multi-memory profile coverage, shell-only Wasm/JIT hooks, and final host-wide Threads stress evidence;
