...
> The latest full run passes **VALID 33,930 / 41,664 (81.4%)**, with **135 parse failures**,
> **7,599 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,930 / 41,664 (81.4%)** |
