...
> The latest full run passes **VALID 40,840 / 47,928 (85.2%)**, with **146 parse failures**,
> **6,942 runtime failures**, **0 host failures**, and **NEGATIVE 3,213 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **40,840 / 47,928 (85.2%)** |
...
| ---- | ------: | ---- | ------: |
| `language` | 17,180 / 19,070 (90.1%) | `Object` | 3,283 / 3,411 (96.2%) |
