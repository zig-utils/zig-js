...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,190 / 3,341 (65.5%) |
...
Latest focused `test/intl402` worker checkpoint: **2,190 / 3,341 (65.5%)**, up **+34** from the previous focused checkpoint of 2,156 / 3,341 after the Temporal calendar-aware add/subtract fixes.
