...
> The latest full run passes **VALID 33,803 / 41,664 (81.1%)**, with **135 parse failures**,
> **7,726 runtime failures**, **0 host failures**, and **NEGATIVE 3,180 / 4,668 (68.1%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,803 / 41,664 (81.1%)** |
...
| ---- | ------: | ---- | ------: |
| `language` | 12,695 / 14,285 (88.9%) | `Object` | 3,218 / 3,411 (94.3%) |
...
| `Number` | 327 / 340 (96.2%) | `WeakSet` | 85 / 85 (100%) |
...
| `staging` | 580 / 991 (58.5%) | `SharedArrayBuffer` | 88 / 104 (84.6%) |
