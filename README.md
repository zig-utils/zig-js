...
- optimizer CFGs beyond ordered exit/continue guards, sequential shared joins, and shared or independent latches; native object effects; and additional backends. See [optimizer status](docs/optimizing-jit.md).
