...
> The latest full run passes **VALID 33,959 / 41,664 (81.5%)**, with **135 parse failures**,
> **7,570 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,959 / 41,664 (81.5%)** |
...
| ---- | ------: | ---- | ------: |
| `language` | 12,710 / 14,285 (89.0%) | `Object` | 3,218 / 3,411 (94.3%) |
...
| `annexB` | 461 / 1,070 (43.1%) | `staging` | 608 / 991 (61.4%) |
...
| `global` | 29 / 29 (100%) | `Function` | 479 / 509 (94.1%) |
