...
The ABI and WebAssembly/conformance changes through `d2fca189` do not execute in these
...
- the remaining post-MVP WebAssembly feature profiles and WebAssembly/JIT shell hooks from
  ...
  plus the precise-GC funcref/externref slot foundation and feature-gated
  reference instruction/multi-table validation core with arbitrary externref
  Table/Global identity and reclamation,
