...
- optimizer CFGs beyond a reducible exit-guard chain optionally ending in one shared/independent-latch branch; native object effects; and additional backends. Current numeric SSA has exact bytecode exits and live moving-GC loop safepoints; see [optimizer status](docs/optimizing-jit.md).
