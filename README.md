...
- automatic/concurrent compaction, a moving nursery, and optimizing-tier execution beyond handler-recoverable but empty-handler numeric SSA, resumable side exits, and poll-safe loop OSR with parallel backedges and one equal-cost inner branch; see the [optimizer status](docs/optimizing-jit.md).
