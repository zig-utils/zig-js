...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,573 / 3,341 (77.0%) |
...
Latest focused `test/intl402` worker checkpoint: **2,573 / 3,341 (77.0%)**, up **+144** from the previous focused checkpoint of 2,429 / 3,341 after the Temporal calendar add/subtract overflow fixes.
