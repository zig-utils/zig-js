...
> The latest full run passes **VALID 33,917 / 41,664 (81.4%)**, with **135 parse failures**,
> **7,612 runtime failures**, **0 host failures**, and **NEGATIVE 3,180 / 4,668 (68.1%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,917 / 41,664 (81.4%)** |
...
| `AsyncIteratorPrototype` | 9 / 9 (100%) | `global` | 29 / 29 (100%) |
