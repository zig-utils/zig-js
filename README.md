...
- automatic/concurrent compaction, a moving nursery, and optimizing-tier execution beyond guarded numeric SSA, exact two-way branches, and the first resumable branch side exit; see the [optimizer status](docs/optimizing-jit.md).
