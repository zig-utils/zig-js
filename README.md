...
The current exported C surface has 86 functions:
...
- **Values** - type and Symbol/BigInt predicates, equality, primitive/fresh-Symbol/exact-BigInt construction, JSON parse/stringify, coercions, and protected handles.
