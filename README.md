...
files**, classified as 431 private (**91 implemented / 340 pending**), 15
...
The first 91 private exports—encoded identity/cell equality, truthiness,
...
requested realm and preserves the first pending exception. The 89-symbol
combined fixture covers sibling realms, foreign-VM rejection, callback
...
separately compiled fixtures pass 20 real cell kinds for each. All 91
...
437 symbols from 54 `src/jsc` files: 421 private (**84 implemented / 337
