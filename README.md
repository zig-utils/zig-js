...
> The latest full run passes **VALID 34,370 / 41,664 (82.5%)**, with **135 parse failures**,
> **7,159 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **34,370 / 41,664 (82.5%)** |
...
| `Array` | 2,732 / 2,991 (91.3%) | `RegExp` | 1,461 / 1,687 (86.6%) |
