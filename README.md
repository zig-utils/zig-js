...
Latest accepted [report](docs/.data/benchmark-comparison-2026-07-29-shared-steady.md) · [1,540 raw samples](docs/.data/benchmark-comparison-2026-07-29-shared-steady.tsv). Equal-work checks, alternating order, dispersion limits, and a 50 ms timing floor are enforced by the harness.

| mode | lanes | wins vs JSC | zig-js / JSC throughput | zig-js scaling | JSC scaling |
| --- | ---: | ---: | ---: | ---: | ---: |
| direct warmed context | 1 | 10 / 10 | **2.27x** | — | — |
| independent steady contexts | 8 | 9 / 10 | **2.50x** | **5.60x** | 5.08x |
| independent cold lifecycles | 8 | 9 / 10 | **2.57x** | **5.43x** | 4.80x |
| shared realm, no GIL | 8 | no public-JSC equivalent | — | **4.54x** | — |
