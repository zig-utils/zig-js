...
> The latest full run passes **VALID 33,833 / 41,664 (81.2%)**, with **135 parse failures**,
> **7,696 runtime failures**, **0 host failures**, and **NEGATIVE 3,180 / 4,668 (68.1%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,833 / 41,664 (81.2%)** |
...
| `Number` | 335 / 340 (98.5%) | `WeakSet` | 85 / 85 (100%) |
