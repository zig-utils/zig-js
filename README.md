...
The current exported C surface has 84 functions:
...
- **Values** - type and Symbol/BigInt predicates, equality, primitive/fresh-Symbol/exact-BigInt construction, coercions, and protected handles.
