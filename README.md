...
- automatic/concurrent compaction, a moving nursery, and optimizing-tier execution beyond the guarded straight-line numeric SSA subset; see the [optimizer status](docs/optimizing-jit.md).
