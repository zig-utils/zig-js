...
> The latest full run passes **VALID 34,129 / 41,664 (81.9%)**, with **135 parse failures**,
> **7,400 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **34,129 / 41,664 (81.9%)** |
...
| `Proxy` | 262 / 310 (84.5%) | `Reflect` | 146 / 153 (95.4%) |
