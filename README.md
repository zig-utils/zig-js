...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,598 / 3,341 (77.8%) |
...
Latest focused `test/intl402` worker checkpoint: **2,598 / 3,341 (77.8%)**, up **+5** from the previous focused checkpoint of 2,593 / 3,341 after storing Temporal PlainMonthDay non-ISO values as ISO reference dates while deriving calendar month/day fields from that reference.
