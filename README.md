...
It tracks the ECMAScript spec closely and is graded against the **real [tc39/test262](https://github.com/tc39/test262) corpus** — currently **42,520 / 47,930 (88.7%)** of the scored "can we run it" tests pass. See [Conformance](#conformance) for the full breakdown.
...
| `String` | 1,118 / 1,223 (91.4%) | `TypedArray` | 1,439 / 1,446 (99.5%) |
