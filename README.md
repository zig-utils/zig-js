...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,591 / 3,341 (77.5%) |
...
Latest focused `test/intl402` worker checkpoint: **2,591 / 3,341 (77.5%)**, up **+1** from the previous focused checkpoint of 2,590 / 3,341 after routing Temporal Duration locale formatting through `Intl.DurationFormat`.
