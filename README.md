...
> The latest full run passes **VALID 33,758 / 41,664 (81.0%)**, with **135 parse failures**,
> **7,771 runtime failures**, **0 host failures**, and **NEGATIVE 3,180 / 4,668 (68.1%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,758 / 41,664 (81.0%)** |
...
| `BigInt` | 77 / 77 (100%) | `ThrowTypeError` | 14 / 14 (100%) |
