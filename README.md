...
files**, classified as 432 private (**23 implemented / 409 pending**), 15
...
The first twenty-three private exports—encoded identity/cell equality, truthiness,
...
operations, plus seven JSCell/JSString operations—now pass focused Zig
...
separately compiled fixtures pass 20 real cell kinds for each. All twenty-three
...
437 symbols from 54 `src/jsc` files: 422 private (**23 implemented / 399
