...
- optimizer CFGs beyond one path-accounted inner branch with shared or independent latches, native object effects, and additional backends. Current numeric SSA has exact bytecode exits and live moving-GC loop safepoints; see [optimizer status](docs/optimizing-jit.md).
