...
Latest accepted [report](docs/.data/benchmark-comparison-2026-07-29-shared-reserve.md) · [1,540 raw samples](docs/.data/benchmark-comparison-2026-07-29-shared-reserve.tsv). Equal-work checks, alternating order, dispersion limits, and a 50 ms timing floor are enforced by the harness.

| mode | lanes | wins vs JSC | zig-js / JSC throughput | zig-js scaling | JSC scaling |
| --- | ---: | ---: | ---: | ---: | ---: |
| direct warmed context | 1 | 10 / 10 | **2.29x** | — | — |
| independent steady contexts | 8 | 9 / 10 | **2.52x** | **5.46x** | 4.96x |
| independent cold lifecycles | 8 | 9 / 10 | **2.53x** | **5.47x** | 4.95x |
| shared realm, no GIL | 8 | no public-JSC equivalent | — | **4.60x** | — |
