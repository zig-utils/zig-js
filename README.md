...
- optimizer CFGs beyond an exit-guard chain followed by sequential shared joins and a final shared/independent latch; native object effects; and additional backends. Current numeric SSA has exact bytecode exits and live moving-GC loop safepoints; see [optimizer status](docs/optimizing-jit.md).
