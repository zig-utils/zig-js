...
> The latest full run passes **VALID 41,762 / 47,928 (87.1%)**, with **119 parse failures**,
> **6,047 runtime failures**, **0 host failures**, and **NEGATIVE 3,213 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **41,762 / 47,928 (87.1%)** |
...
| `Temporal` | 3,300 / 4,603 (71.7%) | `intl402` | 1,437 / 3,341 (43.0%) |
