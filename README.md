...
> The latest full run passes **VALID 34,100 / 41,664 (81.8%)**, with **135 parse failures**,
> **7,429 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **34,100 / 41,664 (81.8%)** |
...
| ---- | ------: | ---- | ------: |
| `language` | 12,745 / 14,285 (89.2%) | `Object` | 3,224 / 3,411 (94.5%) |
| `Array` | 2,599 / 2,991 (86.9%) | `RegExp` | 1,461 / 1,687 (86.6%) |
| `String` | 1,071 / 1,223 (87.6%) | `TypedArray` | 1,217 / 1,446 (84.2%) |
| `TypedArrayConstructors` | 553 / 738 (74.9%) | `Uint8Array` | 70 / 70 (100%) |
...
| `annexB` | 461 / 1,070 (43.1%) | `staging` | 622 / 991 (62.8%) |
...
| `Proxy` | 250 / 310 (80.6%) | `Reflect` | 139 / 153 (90.8%) |
