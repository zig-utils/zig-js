...
The current exported C surface has 94 functions:
...
- **Values** - type and Symbol/BigInt predicates, equality and relation conditions, primitive/fresh-Symbol/exact-BigInt construction, JSON parse/stringify, exact 32/64-bit conversions, coercions, and protected handles.
