...
- native optimizer object effects, call-exception and dynamic-finally dispatch regions, and additional architecture backends. Current AArch64 numeric regions include reducible nested loops and deterministic catch/finally bodies; exact unwind metadata plus owned runtime-operation descriptors/results are in place; see [optimizer status](docs/optimizing-jit.md).
