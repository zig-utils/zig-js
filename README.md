...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,429 / 3,341 (72.7%) |
...
Latest focused `test/intl402` worker checkpoint: **2,429 / 3,341 (72.7%)**, up **+32** from the previous focused checkpoint of 2,397 / 3,341 after the Temporal ZonedDateTime signed difference fixes.
