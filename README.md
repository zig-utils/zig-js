...
> The latest full run passes **VALID 33,734 / 41,664 (81.0%)**, with **156 parse failures**,
> **7,774 runtime failures**, **0 host failures**, and **NEGATIVE 3,180 / 4,668 (68.1%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,734 / 41,664 (81.0%)** |
