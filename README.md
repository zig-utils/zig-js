...
- automatic/concurrent compaction, a moving nursery, and optimizing-tier execution beyond handler-aware numeric SSA (interpreter-owned effects resume exactly in bytecode), resumable side exits, and general loop CFGs; see the [optimizer status](docs/optimizing-jit.md).
