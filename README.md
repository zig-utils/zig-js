...
- automatic/concurrent compaction, a moving nursery, and general optimizing-tier execution beyond the first exact constant-SSA native subset; see the [optimizer status](docs/optimizing-jit.md).
