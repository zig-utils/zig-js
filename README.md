...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,625 / 3,341 (78.6%) |
...
Latest focused `test/intl402` worker checkpoint: **2,625 / 3,341 (78.6%)**, up **+5** from the previous focused checkpoint of 2,620 / 3,341 after tightening Temporal calendar field resolution and PlainYearMonth reference-day handling.
