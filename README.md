...
files**, classified as 431 private (**250 implemented / 181 pending**), 15
...
The first 250 private exports—encoded identity/cell equality, truthiness,
...
the mutable formatted `.stack` property. The 249-symbol combined fixture covers sibling realms,
...
separately compiled fixtures pass 20 real cell kinds for each. All 250
...
437 symbols from 54 `src/jsc` files: 421 private (**244 implemented / 177
