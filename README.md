...
> The latest full run passes **VALID 34,240 / 41,664 (82.2%)**, with **135 parse failures**,
> **7,289 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **34,240 / 41,664 (82.2%)** |
...
| `Proxy` | 307 / 310 (99.0%) | `Reflect` | 153 / 153 (100%) |
