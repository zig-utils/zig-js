...
> The latest full run passes **VALID 33,947 / 41,664 (81.5%)**, with **135 parse failures**,
> **7,582 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,947 / 41,664 (81.5%)** |
...
| `annexB` | 461 / 1,070 (43.1%) | `staging` | 607 / 991 (61.3%) |
...
| `global` | 29 / 29 (100%) | `Function` | 468 / 509 (91.9%) |
