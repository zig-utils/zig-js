...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,585 / 3,341 (77.4%) |
...
Latest focused `test/intl402` worker checkpoint: **2,585 / 3,341 (77.4%)**, up **+12** from the previous focused checkpoint of 2,573 / 3,341 after the Temporal calendar and time-zone mismatch fixes.
