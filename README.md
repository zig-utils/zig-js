...
> `zig build test262` currently passes **VALID 26,161 / 30,486 (85.8%)** across `language/`
...
| ---- | ------- | ------: |
| **valid** | can we run the program? | **26,161 / 30,486 (85.8%)** |
...
| `Object` | 3,052 / 3,411 (89.5%) | | `Date` | 520 / 594 (87.5%) |
