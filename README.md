...
> `zig build test262` currently passes **VALID 26,230 / 30,486 (86.0%)** across `language/`
...
| ---- | ------- | ------: |
| **valid** | can we run the program? | **26,230 / 30,486 (86.0%)** |
...
| `Number` | 319 / 340 (93.8%) | | `Map`/`Set` | 82–88% |
