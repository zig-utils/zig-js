...
> The latest full run passes **VALID 33,756 / 41,664 (81.0%)**, with **135 parse failures**,
> **7,773 runtime failures**, **0 host failures**, and **NEGATIVE 3,180 / 4,668 (68.1%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,756 / 41,664 (81.0%)** |
...
| ---- | ------: | ---- | ------: |
| `language` | 12,691 / 14,285 (88.8%) | `Object` | 3,205 / 3,411 (94.0%) |
| `Array` | 2,599 / 2,991 (86.9%) | `RegExp` | 1,459 / 1,687 (86.5%) |
| `String` | 1,063 / 1,223 (86.9%) | `TypedArray` | 1,216 / 1,446 (84.1%) |
| `Map` | 204 / 204 (100%) | `Set` | 363 / 383 (94.8%) |
| `BigInt` | 75 / 77 (97.4%) | `ThrowTypeError` | 14 / 14 (100%) |
| `Temporal` | 3,209 / 4,603 (69.7%) | `intl402` | 1,427 / 3,341 (42.7%) |
| `annexB` | 461 / 1,070 (43.1%) | `staging` | 577 / 991 (58.2%) |
| `SharedArrayBuffer` | 88 / 104 (84.6%) | `Uint8Array` | 70 / 70 (100%) |
