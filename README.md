...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,620 / 3,341 (78.4%) |
...
Latest focused `test/intl402` worker checkpoint: **2,620 / 3,341 (78.4%)**, up **+10** from the previous focused checkpoint of 2,610 / 3,341 after keeping DateTimeFormat-only Islamic calendar fallbacks out of Temporal calendar identifiers.
