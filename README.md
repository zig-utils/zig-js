...
> The latest full run passes **VALID 33,922 / 41,664 (81.4%)**, with **135 parse failures**,
> **7,607 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **33,922 / 41,664 (81.4%)** |
...
| ---- | ------: | ---- | ------: |
| `language` | 12,706 / 14,285 (88.9%) | `Object` | 3,218 / 3,411 (94.3%) |
...
| `global` | 29 / 29 (100%) | `Function` | 460 / 509 (90.4%) |
