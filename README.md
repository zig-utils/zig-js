...
> `zig build test262` currently passes **VALID 26,199 / 30,486 (85.9%)** across `language/`
...
| ---- | ------- | ------: |
| **valid** | can we run the program? | **26,199 / 30,486 (85.9%)** |
...
| `Object` | 3,090 / 3,411 (90.6%) | | `Date` | 520 / 594 (87.5%) |
