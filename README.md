...
> The latest full run passes **VALID 34,007 / 41,664 (81.6%)**, with **135 parse failures**,
> **7,522 runtime failures**, **0 host failures**, and **NEGATIVE 3,211 / 4,668 (68.8%)**.
...
| ---- | ------- | ------: |
| **valid** | can we run the program? (scored corpus) | **34,007 / 41,664 (81.6%)** |
...
| `global` | 29 / 29 (100%) | `Function` | 499 / 509 (98.0%) |
