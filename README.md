...
- most native optimizer object effects, specialized call forms, constructors, dynamic-finally dispatch, and additional architecture backends. AArch64 executes ordinary calls and `to_numeric` through precisely rooted callbacks, including exact catch/finally continuations without replay; see [optimizer status](docs/optimizing-jit.md).
