...
| `Temporal` | 3,622 / 4,603 (78.7%) | `intl402` | 2,654 / 3,341 (79.4%) |
...
Latest focused `test/intl402` worker checkpoint: **2,654 / 3,341 (79.4%)**, up **+4** from the previous focused checkpoint of 2,650 / 3,341 after accepting the bounded Chinese end-of-range leap month used by Temporal property-bag roundtrips.
