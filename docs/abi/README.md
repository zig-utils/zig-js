...
|---|---:|
| Private JSC/Bun/WebCore ABI under #163 | 431 (226 implemented, 205 pending) |
...
The first 226 private entries are implemented; the other 205 remain pending
...
cross-VM rejection, and exact append/set/swap-remove behavior. The 225-symbol
...
| Classification | Symbols |
|---|---:|
| Private JSC/Bun/WebCore ABI under #164 | 421 (220 implemented, 201 pending) |
| Public-C overlap | 15 |
| Consumer-generated definition (`JSFunctionCall`) | 1 |
| **Total** | **437** |
