...
The published arrays workload still selects the older guarded VM packed-push and packed-sum kernels before optimizer OSR. #450 removes bytecode fallback for general allocating loops; it does not claim direct append/reallocation specialization or a changed benchmark score. Those remain [#449](https://github.com/zig-utils/zig-js/issues/449).
