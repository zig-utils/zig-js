...
The inventory currently records **51 implemented / 57 pending** declarations.
...
predicates, numeric/string conversion, and exact comparison methods. See the [Objective-C bridge inventory
