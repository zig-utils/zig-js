...
or extension totals. The pinned Home inventory currently reports eighty-two
private exports and 349 pending private symbols; `zig build test-home-private-abi` and
`zig build test-private-jstype` are their focused compile-link-runtime gates.
The eighty-two cover JSC64 identity, cell equality,
...
pinned messages and legacy codes. The combined 80-symbol fixture also
...
of which the same seventy-five shims are implemented and 346 remain pending. Its
