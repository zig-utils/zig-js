...
or extension totals. The pinned Home inventory currently reports 146
private exports and 285 pending private symbols; `zig build test-home-private-abi` and
`zig build test-private-jstype` are their focused compile-link-runtime gates.
The 146 cover JSC64 identity, cell equality,
...
committed capacity. The array/index slice supplies exact
...
pinned messages and legacy codes. The combined 145-symbol fixture also
...
of which 140 shims are implemented and 281 remain pending. Its
