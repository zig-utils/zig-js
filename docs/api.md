...
or extension totals. The pinned Home inventory currently reports 233
private exports and 198 pending private symbols; `zig build test-home-private-abi` and
`zig build test-private-jstype` are their focused compile-link-runtime gates.
The 233 cover JSC64 identity, cell equality,
...
pinned messages and legacy codes. The combined 232-symbol fixture also
...
of which 227 shims are implemented and 194 remain pending. Its
