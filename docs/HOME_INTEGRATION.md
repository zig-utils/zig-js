...
private entries are now 47 implemented / 385 pending under #163. The implemented
...
publication, sparse growth, and the maximum-u32 boundary. These slices do not yet create a usable Home
private runtime.
