...
Any edit under `src/` relinks the test artifact — budget ~4–6 minutes. Test-name
...
| Marker | Generator |
| --- | --- |
| `<!-- release-compatibility:*:start/end -->` | `home-tool run tools/release-compatibility.ts --update-readme` |
