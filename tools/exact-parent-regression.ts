...
export function selfTest(): void {
  ...
  const processFixture = [
    ...
    "200 100 /opt/zig build test", "210 100 /cache/maker build test", "220 100 /private/tmp/home-url-final", "230 100 /tmp/home-ts-checker/o/test --listen=-", "240 100 /repo/.zig-cache/o/hash/test --listen=-", "250 100 /repo/zig-out/bin/test262 --diag test/language", "260 100 /repo/zig-out/bin/unit-test-parallel", "270 100 /repo/zig-out/bin/threads-test", "280 100 /other/frontend-parse-benchmark single row 1 1", "290 100 /usr/bin/python3 unrelated.py", "291 100 /opt/zig version", "292 100 /opt/zig --version",
  ].join("\n");
